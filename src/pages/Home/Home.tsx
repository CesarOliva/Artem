...
const HomePage = () => {
    return (
        <main className="mx-auto flex min-h-screen max-w-7xl flex-col gap-8 p-8 md:justify-center md:p-0 mt-4 md:mt-12 mb-24">
            <div className="grid grid-cols-8 gap-8 pb-8">
                <div className="order-1 md:order-0 col-span-8 md:col-span-3 flex flex-col justify-center">
                    ...
                    <p className="text-lg">Explora obras del Museo Met en New York y vive el arte de una nueva manera,</p>
            ...
            <Featured type="featured" value='Picasso'/>

            <Featured type="favorites" value='Diego Rivera'/>
        </main>
    );
}
